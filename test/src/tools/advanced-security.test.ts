...
import { Alert, AlertType, AlertValidityStatus, Confidence, Severity, State } from "nholuongut-node-api/interfaces/AlertInterfaces";
import { PagedList } from "nholuongut-node-api/interfaces/common/VSSInterfaces";
